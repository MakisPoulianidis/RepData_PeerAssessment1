...
head(activity.daytype[activity.daytype$daynum==1,],n=2)
head(activity.daytype[activity.daytype$daynum==2,],n=2)
head(activity.daytype[activity.daytype$daynum==6,],n=2)
head(activity.daytype[activity.daytype$daynum==7,],n=2)
```
